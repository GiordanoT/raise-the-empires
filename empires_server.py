...
_ini_cfg.read(os.path.join(str(base_path()), 'raise_the_empires.ini'))
...
def get_avail_avatars():
    ...
    # TODO
    avatar_list = ["2_pincus_cp_100.png",
                    "4_navy_cp_04_100.png",
                    "5_navy_cp_03_100.png",
                    "6_navy_cp_02_100.png",
                    "7_navy_cp_01_100.png",
                    "8_hans_cp_100.png",
                    "9_art_cp_100.png",
                    "10_army_cp_04_100.png",
                    "11_army_cp_03_100.png",
                    "12_army_cp_02_100.png",
                    "13_army_cp_01_100.png",
                    "14_air_force_cp_04_100.png",
                    "15_air_force_cp_03_100.png",
                    "16_air_force_cp_02_100.png",
                    "17_air_force_cp_01_100.png"]
    return avatar_list
def get_avail_motds():
    motds_dir = os.path.join(app.root_path, "templates", "img", "motds")
    if os.path.exists(motds_dir):
        return [f for f in os.listdir(motds_dir) if f.lower().endswith(('.png', '.jpg', '.jpeg', '.gif'))]
    return []
...
def send_sol_assets(path):
    return send_from_directory_mod('assets/sol_assets/assets', path)
...
def send_from_directory_mod(directory, filename, **options):
    ...
    if not os.path.exists(full_path):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.gif')):
            ...
            fallback_dir = os.path.join(app.root_path, "assets/sol_assets/assets/game/quests")
...
def language_editor():
    tree = ET.parse("assets/game_configs/it_it.xml")
    root = tree.getroot()
    for pkg in root:
